                                ...
                                @foreach($LatestNews as $LatestNew)
                                    ...
                                    if ($LatestNew->$slug_var != "" && Helper::GeneralWebmasterSettings("links_status")) {
                                        if (App::getLocale() != env('DEFAULT_LANGUAGE')) {
                                            $topic_link_url = url(App::getLocale() . "/" . $LatestNew->$slug_var);
                                        } else {
                                            $topic_link_url = url($LatestNew->$slug_var);
                                        }
                                    } else {
                                        if (App::getLocale() != env('DEFAULT_LANGUAGE')) {
                                            $topic_link_url = route('FrontendTopicByLang', ["lang" => App::getLocale(), "section" => $LatestNew->webmasterSection->name, "id" => $LatestNew->id]);
                                        } else {
                        ...
                        <ul class="link-list">
                            @foreach($FooterMenuLinks as $FooterMenuLink)
                                @if($FooterMenuLink->type==3 || $FooterMenuLink->type==2)
                                    ...
                                    <li>
                                        ...
                                        if ($FooterMenuLink->webmasterSection->$slug_var != "" && Helper::GeneralWebmasterSettings("links_status")) {
                                            if (App::getLocale() != env('DEFAULT_LANGUAGE')) {
                                                $mmnnuu_link = url(App::getLocale() . "/" . $FooterMenuLink->webmasterSection->$slug_var);
                                            } else {
                                                $mmnnuu_link = url($FooterMenuLink->webmasterSection->$slug_var);
                                            }
                                        } else {
                                            if (App::getLocale() != env('DEFAULT_LANGUAGE')) {
                                                $mmnnuu_link = url(App::getLocale() . "/" . $FooterMenuLink->webmasterSection->name);
                                            } else {
                                ...
                                @elseif($FooterMenuLink->type==1)
                                    ...
                                    <?php
                                    if (App::getLocale() != env('DEFAULT_LANGUAGE')) {
                                        $this_link_url = url(App::getLocale() . "/" . $FooterMenuLink->link);
                                    } else {
