                            ...
                            @foreach($HomeTopics as $HomeTopic)
                                ...
                                if ($HomeTopic->webmasterSection->$slug_var != "" && Helper::GeneralWebmasterSettings("links_status")) {
                                    if (App::getLocale() != env('DEFAULT_LANGUAGE')) {
                                        $section_url = url(App::getLocale() . "/" . $HomeTopic->webmasterSection->$slug_var);
                                    } else {
                                        $section_url = url($HomeTopic->webmasterSection->$slug_var);
                                    }
                                } else {
                                    if (App::getLocale() != env('DEFAULT_LANGUAGE')) {
                                        $section_url = url(App::getLocale() . "/" . $HomeTopic->webmasterSection->name);
                                    } else {
                                ...
                                if ($HomeTopic->$slug_var != "" && Helper::GeneralWebmasterSettings("links_status")) {
                                    if (App::getLocale() != env('DEFAULT_LANGUAGE')) {
                                        $topic_link_url = url(App::getLocale() . "/" . $HomeTopic->$slug_var);
                                    } else {
                                        $topic_link_url = url($HomeTopic->$slug_var);
                                    }
                                } else {
                                    if (App::getLocale() != env('DEFAULT_LANGUAGE')) {
                                        $topic_link_url = route('FrontendTopicByLang', ["lang" => App::getLocale(), "section" => $HomeTopic->webmasterSection->name, "id" => $HomeTopic->id]);
                                    } else {
                                ...
                                <ul id="thumbs" class="portfolio">
                                    ...
                                    @foreach($HomePhotos as $HomePhoto)
                                        ...
                                        if ($HomePhoto->webmasterSection->$slug_var != "" && Helper::GeneralWebmasterSettings("links_status")) {
                                            if (App::getLocale() != env('DEFAULT_LANGUAGE')) {
                                                $section_url = url(App::getLocale() . "/" . $HomePhoto->webmasterSection->$slug_var);
                                            } else {
                                                $section_url = url($HomePhoto->webmasterSection->$slug_var);
                                            }
                                        } else {
                                            if (App::getLocale() != env('DEFAULT_LANGUAGE')) {
                                                $section_url = url(App::getLocale() . "/" . $HomePhoto->webmasterSection->name);
                                            } else {
                                ...
                                <ul class="thumbnails">
                                    ...
                                    @foreach($HomePartners as $HomePartner)
                                        ...
                                        if ($HomePartner->webmasterSection->$slug_var != "" && Helper::GeneralWebmasterSettings("links_status")) {
                                            if (App::getLocale() != env('DEFAULT_LANGUAGE')) {
                                                $section_url = url(App::getLocale() . "/" . $HomePartner->webmasterSection->$slug_var);
                                            } else {
                                                $section_url = url($HomePartner->webmasterSection->$slug_var);
                                            }
                                        } else {
                                            if (App::getLocale() != env('DEFAULT_LANGUAGE')) {
                                                $section_url = url(App::getLocale() . "/" . $HomePartner->webmasterSection->name);
                                            } else {
