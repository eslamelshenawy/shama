                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="box p-a-xs">
                                                {!! Form::textarea('details_il',$Topics->details_il, array('ui-jp'=>'summernote','placeholder' => '','class' => 'form-control summernote', 'dir'=>trans('backLang.ltr'),'ui-options'=>'{height: 300}')) !!}
                                            </div>
                                        </div>
                                    </div>
                                @endif
